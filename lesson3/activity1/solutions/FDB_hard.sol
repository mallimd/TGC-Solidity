...
contract FixedDepositBox_Hard {
    ...
    constructor(uint256 durationInput, uint8 interestRateInput) payable {
    ...
    function deposit(string calldata password) external payable {
        ...
        require(amountReceived > 0, "Did not receive anything");
    ...
    function widthdrawal(string memory passwordInput) public {
        ...
        if(haveWeWaitedLongEnough) {
            ...
            (bool success, ) = payable(userAddress).call{value: totalAmount}("");
